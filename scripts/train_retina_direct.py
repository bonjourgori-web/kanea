"""
RetinaVision AI — EfficientNet-B0 sur Diabetic Retinopathy (5 classes)
Usage: python scripts/train_retina_direct.py --dataset data/retina --epochs 12
"""
...
def parse_args():
    ...
    p.add_argument("--dataset", default="data/retina")
...
def train(args):
    ...
    for epoch in range(args.epochs):
        ...
        try:
            auc = roc_auc_score(trues, np.vstack(probas), multi_class="ovr", average="macro")
        except Exception:
            auc = 0.0
    ...
    metrics = {
        ...
        "dataset": "Diabetic Retinopathy", "samples_train": n_train,
        "training_time_s": round(time.time() - t0, 1),
    }
    (MODEL_DIR / "retina_model.json").write_text(
